...
public class FlowerEnemy extends Enemy
{
	...
	public FlowerEnemy(LevelScene world, float x, float y, float mapX, float mapY)
	{
	    super(world, (int)x, (int)y, 1, Sprite.KIND_ENEMY_FLOWER, false, (int)mapX, (int)mapY);
	    noFireballDeath = false;
	    this.world = world;
	    this.xPic = 0;
	    this.yPic = 6;
	...
	public FlowerEnemy(LevelScene world, float x, float y, int mapX, int mapY)
	{
	    super(world, (int)x, (int)y, 1, Sprite.KIND_ENEMY_FLOWER, false, (int)mapX, (int)mapY);
	    noFireballDeath = false;
	    this.world = world;
