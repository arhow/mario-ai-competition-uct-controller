...
public class uctagent implements Agent {
	...
	{
		action = sim.optimise_without_mode(st);
	...
	public void integrateObservation(Environment environment)
	{
		...
		if (lost == 1)
		{
			...
			if (Math.abs(sim.levelScene.mario.y - marioFloatPos[1]) > 0.1f)
				sim.levelScene.mario.ya = (marioFloatPos[1] - lastY) * 0.85f;
